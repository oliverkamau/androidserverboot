package com.jwt.auth.mpesa;

import javax.persistence.*;

@Entity
@Table(name="mpesa_transactions_table")
public class C2BPaymentDetails {
    ...
    public C2BPaymentDetails(String transactionType, String transID, String transTime, String transAmount, String businessShortCode, String billRefNumber, String invoiceNumber, String orgAccountBalance, String thirdPartyTransID, String mSISDN, String firstName, String middleName, String lastName) {
